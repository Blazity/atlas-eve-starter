...
- `apps/example-agent` — replaceable domain-neutral Eve app.
- `packages/example` — replaceable shared schema/type package with no Eve dependency.
- `docs/` — human architecture and onboarding docs.
- `.ai/` — AI Harness artifacts, memory, plans, research, decisions, and repo-local skills.

## Boundaries

- Apps own Eve behavior under `apps/<app>/agent/`.
